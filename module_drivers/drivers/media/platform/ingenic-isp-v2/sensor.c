...
static uint32_t sensor_alloc_integration_time(uint16_t int_time, sensor_context_t *p_ctx)
{
	p_ctx->it = int_time;
	return int_time;
}

static uint32_t sensor_alloc_integration_time_short(uint16_t int_time, sensor_context_t *p_ctx)
{
